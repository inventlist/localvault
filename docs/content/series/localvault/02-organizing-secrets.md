---
title: Organizing Secrets in LocalVault
description: Flat keys for simple projects, dot-notation for multi-project team vaults. How to structure your secrets as complexity grows.
type: doc
---
